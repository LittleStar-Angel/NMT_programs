...
#new
#from niutrans_tools.script. import niutrans-tools
import apply_bpe
import codecs
import sys
reload(sys)
...
class Translator:
    ...
    def process_task(self, task):
        ...
        doalign = str(task.get('alignmentInfo',''))
        #print doalign
        #dodetok =  task.get('detokenize','')
        ...
        src_lines_tok = [self.tokenizer.tokenize(line) for line in sentences_list]
        #src_translate = Generalization.generalize_zh(src_lines_tok,lexlist,wordslist)
        src_translate = src_lines_tok
        #apply BPE
        
        #print codecs.decode(src_lines_tok[0],'utf-8')
        #print src_lines_tok[0].decode('unicode_escape')
        #codes = co()
        ...
        #print codecs.decode(src_translate[0],'utf-8')
        #print src_translate[0].decode('utf-8','ignore')
    ...
    def _translate(self, src, doalign, dodetok, nbestsize):
        ...
        translate_proxy = xmlrpclib.ServerProxy(self.translate_proxy_addr,allow_none=True)
       # recase_proxy = xmlrpclib.ServerProxy(self.recase_proxy_addr)
        ...
        for hypo in translation['nbest']:
            ...
            if doalign:
                ...
                parsed_hypo['alignment-raw'] = hypo['align']
